...
1. Crear secreto:
```
kubectl create secret docker-registry gcr-json-key --docker-server=northamerica-northeast1-docker.pkg.dev --docker-username=_json_key --docker-password="$(cat '/home/gabbriel/Escritorio')" --docker-email=juanmendez0013@gmail.com
```
